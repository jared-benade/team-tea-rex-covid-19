namespace TeamTeaRexCovid19.Domain.Models
{
    ...
    {
        public InitialQuestions(string selectedProvince, string suburb, string selectedAgeGroup, bool isSmoker, bool isDrinker, int doesShareLivingSpace, string transportType)
        {
